...
async function updateLeaderboard(player, score) {
  ...
  try {
    ...
    const newValue = { score: score, ship: player.ship.name, asteroids: asteroidsHit, stars: totalGoldStars, shields: totalShields, onMobile: isMobile, time: time, date: getFormattedDate()};
